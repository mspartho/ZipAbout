...
namespace Sprint3
{
    public partial class VehicleUI : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label4.Text = "Rent Per Hour";
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(283, 380);
        ...
        {
            string vehicleType = textBox1.Text;
            string vehicleID = textBox4.Text;
            string modelNumber = textBox2.Text;
            int rentPerHour = int.Parse(textBox3.Text);

            Vehicle vehicle = VehicleFactory.getVehicle(vehicleType, vehicleID, modelNumber, rentPerHour, 0);
            if (vehicle != null)
            {
                Main main = new Main();
                main.AddGroupBoxes();
